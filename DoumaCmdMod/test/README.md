...
流星群の検証では20塊×30ブロック＋破片280個（各素材176個）、実際に受け取った斜めの移動、炎と光の粒子、300回の着弾、クレーターを確認します。洪水はドラウンド30体＋11種類51体、天変地異は地割れ・溶岩に加えて流星群880ブロックも確認します。`--new-effects-only` で追加3項目のみ実行できます。
